...
$query1="SELECT * FROM user_table LEFT JOIN department_table ON user_table.User_id = department_table.User_id WHERE department_table.Department='Human Resource' ";
